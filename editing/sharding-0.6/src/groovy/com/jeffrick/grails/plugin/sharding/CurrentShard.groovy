...
class CurrentShard {
  ...
  // private static HashMap<String, Object> _dataSourceLookup

  static {
    _shardIndex = new ThreadLocal()
    _autoCommit = new ThreadLocal()
    // _indexDataSource = new ThreadLocal();
    // _dataSourceLookup = new HashMap<String, Object>()
  }
  ...
  // static void setDataSourceLookup(HashMap<String, Object> dataSourceLookup) {
