                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="id" title="${message(code: 'library.id.label', default: 'Id')}" />
                    ...
                    <g:each in="${libraryInstanceList}" status="i" var="libraryInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:link action="show" id="${libraryInstance.id}">${fieldValue(bean: libraryInstance, field: "id")}</g:link></td>
