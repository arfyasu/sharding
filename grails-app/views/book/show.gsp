            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="book.library.label" default="Library" /></td>
                            
                            <td valign="top" class="value"><g:link controller="library" action="show" id="${bookInstance?.library?.id}">${bookInstance?.library?.encodeAsHTML()}</g:link></td>
